...
class ValidationTest {
    ...
    void testAdvancedValidate() {
        ...
        Address address2 = new Address(null, "L", "1-st street", "5", "1");
        Map<String, List<String>> result2 = Validator.advancedValidate(address2);
        Map<String, List<String>> expected2 = Map.of(
                "country", List.of(Validator.ERROR_MSG_NOT_NULL, Validator.ERROR_MSG_TOO_SMALL_LENGTH + 4),
                "city", List.of(Validator.ERROR_MSG_TOO_SMALL_LENGTH + 3));
        assertThat(result2).isEqualTo(expected2);

        Address address3 = new Address("USA", null, null, null, "1");
        Map<String, List<String>> result3 = Validator.advancedValidate(address3);
        Map<String, List<String>> expected3 = Map.of(
                "country", List.of(Validator.ERROR_MSG_TOO_SMALL_LENGTH + 4),
                "city", List.of(Validator.ERROR_MSG_NOT_NULL, Validator.ERROR_MSG_TOO_SMALL_LENGTH + 3),
                "street", List.of(Validator.ERROR_MSG_NOT_NULL, Validator.ERROR_MSG_TOO_SMALL_LENGTH + 5),
                "houseNumber", List.of(Validator.ERROR_MSG_NOT_NULL, Validator.ERROR_MSG_TOO_SMALL_LENGTH + 1));
        assertThat(result3).isEqualTo(expected3);
    }
    // END
}
